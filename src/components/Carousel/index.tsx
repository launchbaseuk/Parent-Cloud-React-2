...
function Carousel({navigation}: any) {
  ...
  const handleSwipe = (e: any) => {
    if (e.nativeEvent.contentOffset.x == 0) {
      ...
      if (
        e.nativeEvent.contentOffset.x > 411 &&
        e.nativeEvent.contentOffset.x < 822
      ) {
        setCurrent(1);
      } else {
        setCurrent(2);
        ...
        <ScrollView
          ...
          <View style={{alignItems: 'center', marginTop: 64, width: width}}>
            ...
            <Text
              ...
              Manage your mental wellbeing with Pocket CBT, guided meditations,
              sleep stories and mental health content
            </Text>
          </View>
          <View style={{alignItems: 'center', marginTop: 64, width: width}}>
            ...
            <Text
              ...
              Tune into our upcoming health and wellbeing Live Talks and listen
              to all our latest expert podcasts
            </Text>
          </View>
        </ScrollView>
