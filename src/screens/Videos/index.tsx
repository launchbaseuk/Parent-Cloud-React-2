          ...
          <View>
            ...
            {videos.map((video: any) => {
              ...
              if (typeof video.excerpt == "object") {
                excerpt = video.excerpt.rendered.replace(/(<([^>]+)>)/gi, "");
                details = video.content.rendered.replace(/(<([^>]+)>)/gi, "");
                toExtract = video.content.rendered;
                title = video.title.rendered;
              } else {
                excerpt = video.post_excerpt.replace(/(<([^>]+)>)/gi, "");
                details = video.post_content.replace(/(<([^>]+)>)/gi, "");
