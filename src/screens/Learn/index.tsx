  ...
  const learnOptions = [
    {
      ...
      image: <WhatIsCBT />,
      content:
        `Cognitive Behavioural Therapy or CBT is type of talking therapy that can 
    ...
    },
    {
      ...
      content:
        `A big part of CBT involves acknowledging positive thoughts and feelings, 
