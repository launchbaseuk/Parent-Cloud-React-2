    ...
    <View>
      <ScrollView contentContainerStyle={{ paddingTop: 30, paddingBottom: 20 }}>
        ...
        <LearnCard
          style={true}
          title={"What is CBT?"}
          excerpt={"Learn more about CBT and how it can benefit you."}
          image={<WhatIsCBT />}
          content={`Cognitive Behavioural Therapy or CBT is type of talking therapy that can 
              help you to change the way you think and behave in your everyday life. 
              Whilst CBT therapy can be administered by a practitioner, many of the 
              techniques can be practiced on a daily basis by yourself, enabling you to 
              become your own expert in making practical changes to improve your 
              state of mind. \n
              CBT has been proven to work by over a 1,000 studies and can be effective
              in helping individuals with a number of issues, including anxiety, 
              depression, panic disorder and sleep problems. It's based on the idea that 
              our thoughts, feelings and actions are connected. CBT aims to help you 
              manage overwhelming and negative feelings by offering ways to reflect 
              and challenge them, breaking down negative patterns that keep us feeling
              low. \n
              CBT focuses on the present here-and-now, helping you to find coping 
              mechanisms for challenging situations, whilst relieving negative 
              symptoms. Through regularly utilising the tools offered in our Pocket CBT, 
              you will be able to better recognise your own unhealthy thinking patterns, 
              create new coping mechanisms for stressful situations and feel a stronger 
              sense of mental wellbeing.`}
        />
        <LearnCard
          title={"Practicing gratitude"}
          excerpt={"Acknowledging positive thoughts and feelings."}
          image={<PractisingGratitude />}
          content={`A big part of CBT involves acknowledging positive thoughts and feelings, 
          as well as challenging the negative ones. Practicing gratitude can have a 
          significant on our mental health and positivity. \n
          Try using the 'Practicing Gratitude' section of Pocket CBT to record 
          anything that you notice about your day that you're grateful for. This 
          might be something big, like being grateful for your children, or something
          small, like your morning coffee. \n
          Noticing these moments of being grateful or happy can help us to rewire 
          our brains to develop a more optimistic mindset, naturally placing a 
          stronger focus on the positive parts of our life, and less on the negative.\n`}
        />
        <LearnCard
          title={"Mood tracking"}
          excerpt={"Gain insight into negative patterns that affect your mood and wellbeing."}
          image={<MoodTracking />}
